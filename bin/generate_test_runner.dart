...
Future<void> main(List<String> args) async {
  ...
  for (final file in allFiles) {
    ...
    final base = p.basenameWithoutExtension(rel); // e.g. "test_test_runner"
  ...
  for (final file in allFiles) {
    ...
    if (countOfBase > 1) {
      ...
      alias = '${baseName}_$nextIndex'; // e.g. "test_test_runner_1"
    } else {
      // If basename is unique, just use it
      alias = baseName;                // e.g. "test_second_example_test_runner"
      usedSoFar[baseName] = 1;         // mark it as used once
    }
  ...
  final buffer = StringBuffer()
    ...
    ..writeln()
    ..writeln("import 'package:flutter_gherkin_parser/utils/integration_test_helper.dart';")
