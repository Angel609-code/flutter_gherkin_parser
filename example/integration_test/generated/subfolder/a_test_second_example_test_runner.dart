...
final Map<String, List<String>> _scenariosAndSteps = {
  'Second example of escenario': [
    r'''{"text":"And I fill the \"search\" field with \"Tofu\"","line":5}''',
    r'''{"text":"And I check non-grouping","line":6}''',
    r'''{"text":"And I check non-grouping with this as param","line":7}''',
    r'''{"text":"Then I print \"hello\" or maybe this non-grouping with this as param or this two","line":8}''',
  ],
};
